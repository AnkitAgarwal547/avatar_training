...
function RingGauge({ label, value, color }: { label: string; value: number; color: string }) {
  ...
  useEffect(() => {
    ...
    // Animate dash-offset from full circumference → filled
  ...
  return (
    <div className={styles.gauge}>
      <svg width="100" height="100" viewBox="0 0 100 100">
        ...
        <text x="50" y="68" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9">
          /10
        </text>
      </svg>
...
export default function ScoreCard({ score, onRetry }: ScoreCardProps) {
